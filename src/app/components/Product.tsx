...
export default function Product (){
    return(
        <section className="flexCenter flex-col">
            <div className="border-2 w-full pb-24 rounded-lg bg-blue-400  px-6 lg:px-20 3xl:px-0 mx-auto max-w-[1440px]">
               
                <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
                    <h2 className="bold-40 mt-4 text-white lg:bold-64 xl:max-w-[390px]:">Cheer you from the lonely life</h2>
